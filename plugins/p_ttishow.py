    ...
    if temp.ME in r_j_check:
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                photo="https://envs.sh/YNe.jpg",                                               
                                                 caption=f'<b>ʜᴇʏ, {u.mention} 👋🏻\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴏᴜʀ ɢʀᴏᴜᴘ {message.chat.title}\n\nʏᴏᴜ ᴄᴀɴ ꜰɪɴᴅ ᴍᴏᴠɪᴇꜱ / ꜱᴇʀɪᴇꜱ / ᴀɴɪᴍᴇꜱ ᴇᴛᴄ. ꜰʀᴏᴍ ʜᴇʀᴇ. ᴇɴᴊᴏʏ😉┣ </code>',
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('➡️Join Main Channel⬅️', url='https://t.me/moxi_movies') ] ] )
                )
